...
- (void)setDefaultImageWithURL:(NSURL *)url {
    [self setDefaultImageWithURL:url placeholderImage:[UIImage imageNamed:@"default_image"]];
}

- (void)setDefaultImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder {
